...
public class ServletOutput {
	...
	public static void write(HttpServletResponse response, double data, String key)
			throws IOException {
		 write(response,CreateJsonData(data,key));
	}
	
	public static void write(HttpServletResponse response, String data,String key)
			throws IOException {
		 write(response,CreateJsonData(data,key));
	}
	...
	public static void write(HttpServletResponse response,
		Map<Rgb, Integer> data) throws IOException {
		Map<String, String> stringData = convertToSerializable(data);
		JSONObject json = new JSONObject(stringData);
		write(response, json);
	}

	private static Map<String, String> convertToSerializable(
			Map<Rgb, Integer> data) {
		...
		while (i.hasNext()) {
			...
			output.put(pairs.getKey().toString(),
					Integer.toString(pairs.getValue()));
		}
		return output;
	}
	...
	private static void writeAsJsonString(HttpServletResponse response, String output)
			throws IOException {
